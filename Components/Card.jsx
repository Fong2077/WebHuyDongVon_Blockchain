...
//                 <p className ="font-semibold"> Đã nhận: {campaign.amountCollected} ETH</p>
      ...
      <div className="grid gap-5 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
        {allcampaign?.map((campaign, i) => (
          <div
            ...
            key={i + 1}
            className="cardcam cursor-pointer border overflow-hidden transition-shadow duration-300 bg-white rounded shadow-2xl"
          >
            <img
              src="https://www.vyopta.com/wp-content/uploads/2019/01/iStock-952039816.jpg"
