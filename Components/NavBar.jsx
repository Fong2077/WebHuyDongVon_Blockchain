...
const NavBar = () => {
  ...
  const menuList = [ "Chiến dịch", "Quyên góp", "Thành viên"];
        ...
        <div className="relative flex items-center justify-between">
          <div className="flex items-center">
            ...
            >
              ...
              <img width="40" height="40" src="https://cdn-icons-png.freepik.com/512/3734/3734456.png" alt=""></img>
                    ...
                    <div>
                      ...
                      >
                        <svg className="w-5 text-gray-600" viewBox="0 0 24 24">
                          <path
                            fill="currentColor"
                            d="M19.7,4.3c-0.4-0.4-1-0.4-1.4,0L12,10.6L5.7,4.3c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4L10.6,12L4.3,18.3
                              c-0.4,0.4-0.4,1,0,1.4s1,0.4,1.4,0L12,13.4l6.3,6.3c0.4,0.4,1,0.4,1.4,0s0.4-1,0-1.4L13.4,12l6.3-6.3C20.1,5.3,20.1,4.7,19.7,4.3z"
                          />
                        </svg>
                      </button>
                    </div>
